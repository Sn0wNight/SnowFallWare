...
object DiscordRPC {
    private val ipcClient = IPCClient(1068474184830812241)
    private val timestamp = OffsetDateTime.now()
    private var running = false
    private var fdpwebsite = "nightsnow.ddns.net - "
    ...
    private fun update() {
        ...
        builder.setLargeImage(if (discordRPCModule.animated.get()){"https://i.imgur.com/T7cNGq3.gif"} else {"https://i.imgur.com/htIxaLZ.jpg"})
