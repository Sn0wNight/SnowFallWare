...
public class ModernGuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        try {
            ...
            FontLoaders.F18.drawCenteredString("SnowPanther on TOP!",(float)this.width / 2.0F,(float)this.height / 2.0F + 70.0F,new Color(255,255,255,255).getRGB());
            //BlurUtils.INSTANCE.draw(0, 0, mc.displayWidth, mc.displayHeight, 30f);
            FontLoaders.F40.drawCenteredString("SnowFallWare",(float)this.width / 2.0F,(float)this.height / 2.0F - 70.0F,new Color(255,255,255).getRGB());
            ...
            FontLoaders.F18.drawCenteredString("SnowPanther on TOP!",(float)this.width / 2.0F,(float)this.height / 2.0F + 70.0F,new Color(255,255,255,100).getRGB());
